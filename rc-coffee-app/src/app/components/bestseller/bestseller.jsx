...
<section>
    <div className="most-offered-text mt-16 text-center italic font-sans">
        <h1 className=" mt-5 font-bold text-[#3D1C05]">MOST ORDERED DRINKS</h1>
...
<div className="most-offered-text flex flex-col text-center italic font-sans">
<h2 className=" mt-5 font-bold text-[#3D1C05]">WANT TO LOOK MORE?</h2>
<div className="most-offered-button mt-10">
...
<p className="text-center mt-5">This Site is still in Development Process</p>
</section>
